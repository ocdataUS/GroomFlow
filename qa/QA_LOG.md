...
| 2026-01-06 | codex | Build + deploy + reseed | `npm run build`; `bash scripts/build_plugin_zip.sh`; `docker compose cp/install`; `wp bbgf visits seed-demo --count=8 --force` | `/opt/qa/artifacts/refactor-1767762104/npm-build-2.txt`, `/opt/qa/artifacts/refactor-1767762104/build-plugin-zip-2.txt`, `/opt/qa/artifacts/refactor-1767762104/docker-install-2.txt` | PASS |
| 2026-01-06 | codex | REST proofs (flags + photo + history) | `wp eval rest_do_request` for client flags update, visit fetch, photo attach, history pages | `/opt/qa/artifacts/refactor-1767762104/client-29-flags-update.json`, `/opt/qa/artifacts/refactor-1767762104/visit-2329-after-flags.json`, `/opt/qa/artifacts/refactor-1767762104/visit-2329-photo-add.json`, `/opt/qa/artifacts/refactor-1767762104/client-29-after-photo.json`, `/opt/qa/artifacts/refactor-1767762104/client-29-history-page1.json`, `/opt/qa/artifacts/refactor-1767762104/client-29-history-page2.json`, `/opt/qa/artifacts/refactor-1767762104/photo-import.txt` | PASS |
| 2026-01-06 | codex | Board + modal captures | `node scripts/capture_artifacts.js after`; `node scripts/capture_artifacts.js after-photo` | `/opt/qa/artifacts/refactor-1767762104/board-after-*.png`, `/opt/qa/artifacts/refactor-1767762104/modal-after-*.png`, `/opt/qa/artifacts/refactor-1767762104/board-after-photo-*.png`, `/opt/qa/artifacts/refactor-1767762104/modal-after-photo-*.png` | PASS |
| 2026-01-06 | codex | Manual admin happy-path | WP-CLI DB edits + settings reset (see QA_TOOLBELT template) | `/opt/qa/artifacts/refactor-1767762104/manual-admin-happy-path.txt` | PASS |
| 2026-01-06 | codex | Stabilization + PHPCS cleanup | `qa-phpcbf plugin/bb-groomflow`; `qa-phpcs plugin/bb-groomflow` | `/opt/qa/artifacts/run-1767754528/phpcbf-5.txt`, `/opt/qa/artifacts/run-1767754528/phpcs-final.txt` | PASS |
| 2026-01-06 | codex | Build + deploy + reseed | `npm run build`; `bash scripts/build_plugin_zip.sh`; `docker compose cp/install`; `wp bbgf visits seed-demo --count=8 --force` | `/opt/qa/artifacts/run-1767754528/npm-build.txt`, `/opt/qa/artifacts/run-1767754528/build_plugin_zip.txt`, `/opt/qa/artifacts/run-1767754528/docker-install.txt` | PASS |
| 2026-01-06 | codex | REST proofs + UI captures | `node scripts/capture_artifacts.js before/after`; `curl .../clients/27` update + history (cookie+nonce auth) | `/opt/qa/artifacts/run-1767754528/board-after-1366x768.png` (full set in run dir), `/opt/qa/artifacts/run-1767754528/curl-client27-update.json`, `/opt/qa/artifacts/run-1767754528/curl-client27-history.json` | PASS |
| 2025-12-31 | codex | v0 beta smoke | Build/zip install via script + wpcli install; seed-demo (--force); checkout visit via REST with wp_set_current_user; board page smoke screenshot | `/mnt/c/Projects/GroomFlow/build/bb-groomflow-0.1.0-dev.zip`, `/opt/qa/artifacts/board-smoke.png` | PASS (basic smoke) |
