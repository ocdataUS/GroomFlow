...
- **QA & release:** Manual ZIP packaging, Docker WP installs, `bash scripts/qa_fast.sh`, `scripts/qa-phpcs plugin/bb-groomflow`, full admin happy-path, and Asana/handoff updates before review.
